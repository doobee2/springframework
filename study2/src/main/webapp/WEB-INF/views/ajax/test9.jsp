...
<head>
    ...
    <style>
        ...
        #tb1 th { border-top:2px solid #333; border-bottom:2px solid #333; background-color:palegoldenrod; line-height:30px; min-width:150px;
            padding-left: 24px; padding-right: 24px; }
        #tb1 td { border-bottom:1px solid #333;  line-height: 30px; min-width:150px;  padding-left: 24px; padding-right: 24px; }
        #tb1 tbody tr:last-child td { background-color:palegoldenrod; }
    </style>
</head>
<body>
<nav>
